...
/**
	...
	*/
RBDYN_DLLAPI void centralFD(Joint::Type type, const std::vector<double>& alpha,
...
/**
	...
	* @param step Integration step.
	*/
RBDYN_DLLAPI void centralFD(const MultiBody& mb, MultiBodyConfig& mbc, double step);

/// safe version of @see eulerIntegration.
RBDYN_DLLAPI void sCentralFD(const MultiBody& mb, MultiBodyConfig& mbc, double step);
